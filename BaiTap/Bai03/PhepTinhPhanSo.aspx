    ...
    <article class="main-Content">
        ...
        <table >
                <tr>
                    ...
                    <td>
                        <asp:TextBox ID="txtPhanSo1" runat="server" Width="1581%"></asp:TextBox>
                    </td>
                </tr>
                <tr>
                    <td>Phân số 2</td>
                    <td>
                        <asp:TextBox ID="txtPhanSo2" runat="server" Width="1844%"></asp:TextBox>
                    </td>
                </tr>
                <tr>
                    <td>
                    ...
                    <td>
                        <asp:TextBox ID="txtKetQua" runat="server" ReadOnly="True" Width="1925%" BackColor="#C4C4FF"></asp:TextBox>
                    </td>
                </tr>
                <tr>
...
&nbsp;<asp:ImageButton ID="btnXoaNoiDung" runat="server" ImageUrl="~/Images/math_clear_red.png" OnClick="btnXoaNoiDung_Click" />
                    </td>
                </tr>
            </table>
    </article>
