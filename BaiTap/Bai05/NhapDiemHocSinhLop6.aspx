<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="NhapDiemHocSinhLop6.aspx.cs" Inherits="BaiTap.Bai05.NhapDiemHocSinhLop6" %>
...
<body>
 <form id="form1" runat="server">
        <div class="main-Content">
            ...
            <div class="form-group">
                <asp:Label ID="Label5" runat="server" Text="Ngữ Văn" CssClass="col-left control-label"></asp:Label>
                <div class="col-right">
                    <asp:TextBox ID="txtNguVan" runat="server" CssClass="form-control"></asp:TextBox>
                </div>
            </div>
            <div class="form-group">
